...
const HajjTabs = () => {
  ...
  const tabs = [
    { label: 'Trip', value: '/hajj/trip' },
    { label: 'Check Registration', value: '/hajj/checkRegistration' },
    { label: 'Pilgrim', value: '/hajj/pilgrim' },
    { label: 'Ticket Requisition', value: '/hajj/ticket-requisition' },
    { label: 'Payment', value: '/hajj/payment' },
    { label: 'Hotel Booking', value: '/hajj/hotelBooking' },
    { label: 'Voucher', value: '/hajj/voucher' },
    { label: 'Departure', value: '/hajj/departure' },
  ];

  // Get current route to set the active tab
  const currentPath = location.pathname;
  const value = tabs.find((tab) => currentPath.startsWith(tab.value))?.value || '/hajj/trip';
