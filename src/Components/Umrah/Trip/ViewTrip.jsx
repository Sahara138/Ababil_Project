...
//         >
//           {[ 
//             { label: "Trip Name", value: umrahTripData.tripName },
//             { label: "Departure Date", value: umrahTripData.departureDate },
//             { label: "Return Date", value: umrahTripData.returnDate },
//             { label: "Trip Type", value: umrahTripData.tripType },
//             { label: "Destination", value: umrahTripData.destination },
//             { label: "Remarks", value: umrahTripData.remarks },
//           ].map((item, index) => (
//             <Box
//               key={index}
//               sx={{
