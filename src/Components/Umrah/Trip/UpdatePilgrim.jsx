...
const UpdatePilgrim = () => {
  ...
  useEffect(() => {
    fetch("http://localhost:8000/userRows/" + user_id)
      ...
      .then((data) => {
        ...
        console.log(reference,trip,passportDetails,firstName,middleName,lastName,gender,birthDate,nationality,passportNo,passportExpireDate);
      })
      .catch((err) => {
  ...
  const handleSubmit = (e) => {
    ...
    const updatedFormData = { reference, trip,passportDetails,firstName,middleName,lastName, gender, birthDate,nationality,passportNo,passportExpireDate }
      if (validate()) {
