...
const UpdateTrip = () => {
  ...
  const { _id } = useParams(); // Assuming the trip ID is passed via the URL
  ...
  const handleCancel = () => navigate("/umrah/trip");
    ...
    <div style={{ width: "100%" }}>
      ...
      >
        ...
        <form onSubmit={handleSubmit}>
          ...
          <div className="infoRow">
            <div className="inputField">
              <label htmlFor="returnFlightDate">Return Flight Date</label>
              <input
                id="returnFlightDate"
                type="date"
          ...
          <div className="infoRow">
            <div className="inputField">
              <label htmlFor="stayFirst">Stay First</label>
              <input
                id="stayFirst"
                type="text"
                value={stayFirst}
          ...
          <div className="infoRow">
            ...
            {bookedMeccaHotel && (
              <>
                <div className="inputField">
                  <label htmlFor="meccaHotel">Mecca Hotel</label>
                  <input
                    id="meccaHotel"
                    type="text"
                    value={meccaHotel}
                ...
                <div className="inputField">
                  <label htmlFor="durationOfMeccaStay">Duration of Mecca Stay (days)</label>
                  <input
            ...
            {bookedMadinaHotel && (
              <>
                <div className="inputField">
                  ...
                  <div className="inputField">
                    <label htmlFor="durationOfMadinaStay">Duration of Madina Stay (days)</label>
                    <input
