...
const UpdateUser = () => {
  ...
  const validate = () => {
    const newErrors = {};
    const { id, name, phone, email, role, permission } = userData;
  ...
  return (
    <div style={{ width: "100%" }}>
      ...
      >
        ...
        <div className="user-update" style={{ width: "100%" }}>
          ...
          <form onSubmit={handleSubmit}>
            <div className="infoRow">
              <div className="inputField">
                <label style={{ color: isDarkMode ? "#99a1b7" : "inherit" }} htmlFor="id">
                  ID
                </label>
                <input
                  id="id"
              ...
              <div className="inputField">
                <label style={{ color: isDarkMode ? "#99a1b7" : "inherit" }} htmlFor="name">
                  Name
                </label>
                <input
                  id="name"
              ...
              <div className="inputField">
                <label style={{ color: isDarkMode ? "#99a1b7" : "inherit" }} htmlFor="phone">
                  Phone
                </label>
                <input
                  id="phone"
            ...
            <div className="infoRow">
              ...
              <div className="inputField">
                <label style={{ color: isDarkMode ? "#99a1b7" : "inherit" }} htmlFor="avatar">
                  Avatar
                </label>
                <input
                  id="avatar"
              ...
              <div className="inputField">
                <label style={{ color: isDarkMode ? "#99a1b7" : "inherit" }} htmlFor="position">
                  Position
                </label>
                <input
                  id="position"
            ...
            <div className="inputField">
              ...
              <div className="inputField">
                <label style={{ color: isDarkMode ? "#99a1b7" : "inherit" }} htmlFor="role">
                  Role
                </label>
                <Select
                  id="role"
              ...
              <div className="inputField">
                <label style={{ color: isDarkMode ? "#99a1b7" : "inherit" }} htmlFor="permission">
                  Permission
                </label>
                <Select
                  id="permission"
